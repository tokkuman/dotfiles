...
(define-key minibuffer-local-completion-map "M-c" 'copy-region-as-kill)
...
(add-to-list 'custom-theme-load-path "/opt/local/share/emacs/26.3/etc/themes/themes")
(setq custom-theme-directory "/opt/local/share/emacs/26.3/etc/themes/themes")
